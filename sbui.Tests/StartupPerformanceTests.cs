...
// Alias needed: class Sbui lives in namespace Sbui, causing resolution conflicts from Sbui.Tests
using SbuiApp = global::Sbui.Sbui;
using SbuiUi = global::Sbui.SbuiUi;
using CallbackContext = global::Sbui.CallbackContext;
using SectionBuilder = global::Sbui.SectionBuilder;

namespace Sbui.Tests
{
    /// <summary>
    /// Startup performance benchmarks that run the full Sbui UI creation pipeline
    /// on an STA thread — no Streamer.bot required.
    ///
    /// Pass null for CPH; SettingsManager gracefully returns empty settings.
    /// Each test reports per-phase timings via the PerformanceTracer built into Sbui.
    ///
    ...
    public class StartupPerformanceTests
    {
        ...
        public void FullUI_StartupTiming()
        {
            ...
            RunOnSta(() =>
            {
                ...
                SbuiUi.Create(null, "PerfTest_NoImage", "1.0")
                    .Section("General Settings", "General", g => g
                        .Intro("Test all Sbui controls.")
                ...
                SbuiUi.Create(null, "PerfTest_Warm", "1.0")
                ...
                SbuiUi.Create(null, "PerfTest_Image", "1.0")
