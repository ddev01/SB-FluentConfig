            ...
            SbuiUi.Create(CPH, "Sbui Full Test", "1.0")
                ...
                .Section("General Settings", "General", g => g
                    ...
                    .Slider("Required Value", "custom_required_value")
                        ...
                        .Default(250)
                    .Separator()
                    .SliderWithToggle("Optional Limit", "optional_limit")
                    ...
                    .ResponseBox("Response Template", "response_template")
                ...
                .Section("Advanced Controls", "Advanced", a => a
                    ...
                    .CompetingToggles("Mode", "mode_index")
                        .Hint("Only one mode can be active.")
                        .Options(new[] { "Mode 1", "Mode 2", "Mode 3" })
                        .DefaultIndex(0)
