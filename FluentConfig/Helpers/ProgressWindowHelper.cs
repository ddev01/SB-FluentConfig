...
{
    /// <summary>
    /// Creates a progress window and returns IProgressReporter. Used by FluentConfig.ShowProgressWindow.
    /// </summary>
    public static class ProgressWindowHelper
    {
        ...
        /// </summary>
        public static global::FluentConfig.IProgressReporter Show(Window owner, string title, string message, string progressLabel, int total)
        {
