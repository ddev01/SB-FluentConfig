...
namespace FluentConfig.Core
{
    ...
    public class SettingsManager
    {
        ...
        /// <summary>
        /// Persists the given settings to CPH.
        /// </summary>
        ...
        public T GetValue<T>(string key, T defaultValue = default)
        {
            ...
            var token = SettingsPathHelper.GetNestedValue(_settings, key);
        ...
        public void SetValue<T>(string key, T value)
        {
            ...
            if (string.IsNullOrEmpty(key))
                return;
            SettingsPathHelper.SetNestedValue(_settings, key, value == null ? JValue.CreateNull() : JToken.FromObject(value));
        }

        /// <summary>
        /// Removes keys from the in-memory settings object.
        /// </summary>
        public void RemoveKeys(params string[] keys)
        {
            if (_settings == null || keys == null) return;
            foreach (var key in keys)
            {
                ...
                if (!key.Contains("[") && !key.Contains("."))
                    ...
                    SettingsPathHelper.RemoveNestedValue(_settings, key);
            }
        }

        /// <summary>
        /// Returns the current in-memory settings JObject.
        /// </summary>
        ...
        /// <summary>
        /// Replaces the in-memory settings reference (e.g. after a deep merge).
        /// </summary>
        public void ReplaceSettings(JObject settings)
        {
