...
Release `dist/index.html` should stay near **~150–160 KB** (soft gate **161 KB** in `vite.config.ts`, plus a mock-string check). Do not chase extra terser passes — minify is already on.
