...
namespace FluentConfig.Elements
{
    public class DurationInputElement : UIElement
    {
        ...
        public override void Render(IRenderContext context)
        {
            ...
            var outer = FluentConfigComponentFactory.CreateTitledStack(Title, Description);
            outer.Tag = FluentConfigTags.DurationPrefix + SaveKey;
            ...
            var unitCombo = FluentConfigComponentFactory.CreateComboBoxForEmbedded(options, unitIndex);
