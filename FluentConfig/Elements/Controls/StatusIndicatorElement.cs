...
{
    /// <summary>
    /// Renders a status indicator (colored dot) with optional label and button. Status can be updated via FluentConfig.SetStatusIndicator(key, "Green"|"Red") or UiContext.SetStatus(key, "Green").
    /// </summary>
    public class StatusIndicatorElement : UIElement
    {
        ...
        public override void Render(IRenderContext context)
        {
            ...
            if (!string.IsNullOrEmpty(ButtonText) && OnClickCallback != null)
            {
                ...
                var ctx = new UiContext((global::FluentConfig.FluentConfig)context);
